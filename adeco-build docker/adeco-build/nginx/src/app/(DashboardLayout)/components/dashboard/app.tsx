...
const Dashboard2: React.FC = () => {
  ...
  useEffect(() => {
    const fetchMetrics = async () => {
      try {
        const response = await fetch(`${API_URL}/get-dashboard-metrics.php`);
    ...
    const fetchRecentUsers = async () => {
      try {
        const response = await fetch(`${API_URL}get-recent-users.php`);
        const data = await response.json();
        setRecentUsers(data);
      } catch (error) {
    ...
    const fetchRecentAccess = async () => {
      try {
        const response = await fetch(`${API_URL}get-recent-access.php`);
        const data = await response.json();
    ...
    const fetchExpiredTags = async () => {
      try {
        const response = await fetch(`${API_URL}get-expired-tags.php`);
        const data = await response.json();
        setExpiredTags(data);
      } catch (error) {
